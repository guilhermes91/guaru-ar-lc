# Mapa do site — Guaru Ar LC

Gerado do build de produção por `node scripts/gerar-mapa.mjs`.
...
| Rota | Por quê |
| --- | --- |
| `/admin/` | Painel do cliente. `noindex, nofollow`, `Disallow` no robots.txt, `X-Frame-Options: DENY`, sem cache. |
| `/api/*` | Rotas do painel. `noindex`, `no-store`, todas exigem sessão exceto login e recuperação. |
| `/404`, `/_not-found/` | Página de erro. `noindex, follow`, sem canonical. |
...
**Menu:** Início · Serviços (submenu com os três) · Produtos · Marcas · Como funciona · Sobre nós · Áreas de atendimento · Contato · botão de WhatsApp

**Rodapé:** logo e descrição · redes sociais · navegação · lista de serviços · contato · botão de WhatsApp


## Cobertura — 41 bairros, cada um com página própria

- **Região I** — Barra Grande, Santa Cruz, Marinas, Guaiúba, Tombo, Las Palmas, Santa Rosa, Vila Lygia, Astúrias, Santa Maria, Helena Maria, Pitangueiras, Santo Antônio, Cachoeira
- **Região II** — Itapema, Parque Estuário, Jardim Progresso, Pae Cará, Vila Áurea, Porto de Guarujá, Boa Esperança, Conceiçãozinha, Bocaina, Vicente de Carvalho
- **Região III** — Enseada, Cidade Atlântica, Virgínia, Pedreira, Mar e Céu, Península, Pernambuco, Acapulco, Perequê, Santo Amaro, Guararú, Jardim Acapulco
- **Região IV** — Retroporto, Vargem Grande, Morrinhos, Vila Zilda, Saco do Funil

## Cidades atendidas

- **Peruíbe a Mongaguá** — Peruíbe, Itanhaém, Mongaguá
- **Baixada Santista** — Praia Grande, São Vicente, Santos, Guarujá, Bertioga
- **Litoral Norte até Ilhabela** — São Sebastião, Ilhabela
